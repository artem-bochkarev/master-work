...
CLaboratoryMultiPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CLaboratoryFactory::getLaboratory(Tools::Logger& logger, const std::string& fileNameM)
{
...
CLaboratoryMultiPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CLaboratoryFactory::noFile(Tools::Logger& logger)
{
	...
	CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> strategy(new CGeneticStrategyImpl< CAutomatImpl<COUNTERS_TYPE, INPUT_TYPE> >(antCommon, labResults.get(), fitnesFunctor, strings, logger));
...
CLaboratoryMultiPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CLaboratoryFactory::createLaboratory(CAntCommonPtr<COUNTERS_TYPE> antCommon,
	CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> strategy, CLabResultMultiPtr<COUNTERS_TYPE, INPUT_TYPE> labResults)
{
	return CLaboratoryMultiPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE>(
		new CLaboratoryMulti<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE>(antCommon, strategy, labResults));
}
...
CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CStrategyFactory::createStrategy(const std::vector< std::string >& strings,
...
CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CStrategyFactory::createStrategyCPU(const std::vector< std::string >& strings,
	CAntCommonPtr<COUNTERS_TYPE> antCommon, CLabResultMultiPtr<COUNTERS_TYPE, INPUT_TYPE> labResults, Tools::Logger& logger)
{
	//size_t ste
	CAntFitnesCPUPtr fitnesFunctor(new CAntFitnesCPU(DEFAULT_STEPS_COUNT));
	for (size_t i = 0; i < strings.size(); ++i)
	{
		...
		if (boost::starts_with(str, "transition"))
		{
			...
			{
				return CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE>(
...
CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CStrategyFactory::createStrategyCL(const std::vector< std::string >& strings,
	CAntCommonPtr<COUNTERS_TYPE> antCommon, CLabResultMultiPtr<COUNTERS_TYPE, INPUT_TYPE> labResults, Tools::Logger& logger)
{
...
CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE> CStrategyFactory::createStrategyWRAP(const std::vector< std::string >& strings,
	CAntCommonPtr<COUNTERS_TYPE> antCommon, CLabResultMultiPtr<COUNTERS_TYPE, INPUT_TYPE> labResults, Tools::Logger& logger)
{
	CAntFitnesNonePtr fitnesFunctor(new CAntFitnesNone());
	return CGeneticStrategyCommonPtr<COUNTERS_TYPE, INPUT_TYPE, ANT_FITNES_TYPE>(
